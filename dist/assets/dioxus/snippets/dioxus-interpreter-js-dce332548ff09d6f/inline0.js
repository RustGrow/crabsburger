...
function truthy(val) {
  return val === "true" || val === true;
    ...
    const evt = [];
                    ...
                    }let s = "";let lsp,sp,sl; let c = new TextDecoder();let u16buf,u16bufp;let u32buf,u32bufp;const attr = [];
            ...
            let value,event_name,id,field,ptr,len,ns,bubbles;
